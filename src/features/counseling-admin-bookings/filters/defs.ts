// src/features/counseling-admin-bookings/filters/defs.ts
...
export const ADMIN_BOOKINGS_FILTER_DEFS: FilterDef<AdminBookingsFilters>[] = [
  ...
  { key: "problemCategoryId", label: "ประเภทเรื่อง", type: "select", options: [{ label: "ทั้งหมด", value: "" }] },
  { key: "consultantId", label: "ผู้ให้คำปรึกษา", type: "select", options: [{ label: "ทั้งหมด", value: "" }] },
];
