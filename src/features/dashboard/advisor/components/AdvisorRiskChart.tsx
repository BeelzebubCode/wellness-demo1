...
import { RiskTrendItem } from "../hooks/useAdvisorStats";
...
export function AdvisorRiskChart({ data }: Props) {
  const chartData = {
  ...
  return (
    <Card className="col-span-1 border-gray-200 shadow-sm">
      <CardHeader>
        ...
        <CardDescription>ค่าเฉลี่ยความเสี่ยงของนิสิตในความดูแลย้อนหลัง</CardDescription>
      </CardHeader>
      <CardContent>
        {data.length > 0 ? (
