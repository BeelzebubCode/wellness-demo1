...
export function ExecutiveSummarySection({ stats }: ExecutiveSummarySectionProps) {
    ...
    // For 'Other', we calculate remaining to ensure total is 100%, or just calc directly
    // Direct calculation is safer for display, but for bar width might need adjustment if rounding error
    // Let's just use direct calc for simplicity, visual diff is negligible
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* 2. Top Problem - Orange/Amber Gradient (Changed from Pink) */}
                <Card className="border-none shadow-md relative overflow-hidden group">
                    ...
                    <CardContent className="relative p-6 text-white h-full flex flex-col justify-between">
                        <div>
                            ...
                            {/* Allow text wrapping with leading-tight */}
                ...
                {/* 3. Gender Ratio - Slate/Gray Gradient (Updated with Other) */}
                <Card className="border-none shadow-md relative overflow-hidden group">
