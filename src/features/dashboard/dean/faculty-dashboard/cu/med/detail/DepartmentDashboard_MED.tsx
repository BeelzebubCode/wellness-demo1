...
export function DepartmentDashboard_MED({ department, onBack, onBackToList }: Props) {
  ...
  // Use data from department prop if available
  const riskData = department.riskData || [
    { name: "วิกฤต (Critical)", value: 2, color: RISK_COLORS.Critical },
    { name: "สูง (High)", value: 5, color: RISK_COLORS.High },
    { name: "ปานกลาง (Moderate)", value: 8, color: RISK_COLORS.Moderate },
    { name: "ปกติ (Normal)", value: 15, color: RISK_COLORS.Normal },
  ];
  ...
  const trendData = department.trendData || [
    ...
    { month: "เม.ย.", sessions: 5 },
    { month: "พ.ค.", sessions: 12 },
    { month: "มิ.ย.", sessions: department.sessions || 7 },
  ];
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
               ...
               <div className="flex flex-col">
                  ...
                  <p className="text-slate-500 font-bold text-lg leading-none">คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย</p>
               </div>
            </div>
          </div>
