...
import { DepartmentStat } from "../listing/DepartmentList_AGRI";
import { 
...
export function DepartmentDashboard_AGRI({ 
  department, 
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 pt-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            <div className="flex items-center gap-4">
                {onBackToList && (
                    <>
                        ...
                        className="group flex items-center gap-2 text-slate-400 hover:text-orange-600 transition-all font-bold text-sm"
                        >
                        <div className="p-1.5 rounded-lg bg-white shadow-sm border border-slate-100 group-hover:border-orange-600">
            ...
            <div className="flex items-center gap-4">
               <div className="w-16 h-16 bg-white rounded-2xl shadow-lg border border-slate-100 flex items-center justify-center text-orange-600">
               ...
               <div className="flex flex-col">
                  <div className="flex items-center gap-3 mb-2 whitespace-nowrap">
                    ...
                    <span className="text-sm font-black text-orange-600 bg-orange-50 border border-orange-100 px-2.5 py-0.5 rounded-lg uppercase tracking-wider shrink-0 transform translate-y-[4px]">{department.code}</span>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-lg shadow-slate-200/30 p-8 border border-slate-100 flex flex-col">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
              ...
              <div className="px-4 py-2 bg-orange-50 rounded-2xl border border-orange-100 text-orange-600 text-xs font-black flex items-center gap-2 shrink-0">
            ...
            <div className="h-[280px] w-full mt-auto">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={trendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="colorSessionsDeptAGRI" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <Area 
                    ...
                    strokeWidth={5}
                    fillOpacity={1} 
                    fill="url(#colorSessionsDeptAGRI)" 
                          ...
                          <div className="bg-white p-4 rounded-2xl shadow-xl border-0">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs font-black">
                                ...
                                <span className="text-orange-600">{data.total} คน</span>
                              </div>
                            </div>
                          </div>
                        );
