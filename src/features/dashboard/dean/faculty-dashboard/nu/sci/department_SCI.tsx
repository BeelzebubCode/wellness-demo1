...
import { MOCK_DEPARTMENTS_NU_SCI, DepartmentStat } from "./listing/DepartmentList_SCI";
import { DepartmentDashboard_SCI } from "./detail/DepartmentDashboard_SCI";
...
export function Department_SCI() {
  ...
  const summaryStats: SummaryStat[] = [
    ...
    },
    {
      ...
      footer: (
        <div className="flex items-center gap-2">
          <span className="text-yellow-600 bg-yellow-50 px-1.5 py-0.5 rounded text-[11px] font-black">
            ติดตามอยู่
          </span>
  ...
  const problemDistribution: RiskItem[] = Object.entries(data.problemStats)
    ...
    .map(([name, value], index) => ({
      ...
      color: ["#eab308", "#facc15", "#fde047", "#84cc16", "#cbd5e1"][index] || "#cbd5e1",
    }));
