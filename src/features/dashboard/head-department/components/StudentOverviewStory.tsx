// src/features/dashboard/head-department/components/StudentOverviewStory.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Card 1: ภาพรวมนิสิต — สัดส่วนเคยมาปรึกษา vs ไม่เคย
// ─────────────────────────────────────────────────────────────────────────────
"use client";
...
export default function StudentOverviewStory({ delay = 0 }: { delay?: number }) {
