  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`
          w-full px-3 py-2.5 text-xs font-medium border-2 rounded-xl flex items-center justify-between text-left transition-all
      ...
      {selected.length > 0 && (
        <div className="mt-2 flex flex-wrap gap-1.5 animate-fadeIn max-h-32 overflow-y-auto custom-scrollbar">
            {selected.map(code => (
                <div key={code} className="px-2 py-1 bg-gradient-to-r from-gray-900 to-gray-700 text-white text-[10px] font-medium rounded-md shadow-sm flex items-center gap-1 flex-shrink-0">
                ...
                {categories.map((cat) => {
                    ...
                    return (
                        <button
                            ...
                            className={`
                                w-full px-3 py-2.5 rounded-lg flex items-center justify-between text-xs text-left transition-all
                                ${isSelected 
