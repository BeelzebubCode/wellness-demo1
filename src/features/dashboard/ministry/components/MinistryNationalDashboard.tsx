...
import { Users, AlertTriangle, ShieldCheck, TrendingUp, CheckCircle, XCircle } from "lucide-react";
...
export function MinistryNationalDashboard() {
    ...
    return (
        <div className="space-y-6 max-w-[1600px] mx-auto pb-12">
            {/* Header Section */}
            <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 rounded-3xl p-8 lg:p-10 shadow-xl mb-8 border border-white/10">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        ...
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight">
                            แดชบอร์ดส่วนกลาง
                            <span className="block text-xl md:text-2xl mt-2 font-medium text-slate-300">National Healthcare Analytics</span>
                        </h1>
            ...
            <section className="relative z-50 -mt-14 mb-8">
