...
// Rector-specific booking story — injects global filters into every API call
"use client";
...
export default function RectorBookingSection({ apiPath, title, delay = 0, globalFilters = {} }: Props) {
    ...
    // Merge global filters into story filter params
    ...
    // Use global date when set, otherwise use local preset
    ...
    const { data, loading, meta } = useStoryData<any>(apiPath, "bookings", mergedFilters, effectiveDate, effectiveRange);
