// src/features/dashboard/rector/components/RectorFacultySelectionPage.tsx
"use client";
...
import { useRectorFaculties } from "../hooks/useRectorFaculties";

export function RectorFacultySelectionPage() {
    const { faculties, isLoading, error } = useRectorFaculties();
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
            ...
            <div className="max-w-7xl mx-auto mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Faculty Overview</h1>
                <p className="text-gray-600">View detailed statistics for each faculty in your university</p>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {currentFaculties.map((faculty) => {
                    ...
                    return (
                        <Link
                            key={faculty.id}
                            href={`/rector/faculties/${faculty.code}`}
                        ...
                        >
                            <div className="bg-gradient-to-br from-[rgba(var(--primary),0.05)] to-[rgba(var(--accent),0.05)] p-6 flex items-center justify-center border-b border-gray-100">
                                <div className="w-24 h-24 bg-white rounded-full shadow-lg flex items-center justify-center p-2 relative">
                                    <Image
                                        ...
                                        onError={(e) => {
                                            ...
                                            if (parent) {
                                                parent.innerHTML = `<div class="text-2xl font-bold text-[rgb(var(--primary))]">${faculty.code}</div>`;
                                            }
                                        }}
                                    />
                                </div>
