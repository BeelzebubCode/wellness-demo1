...
import { BorrowRequestListCard } from "@/components/counseling-admin/borrow-requests";
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={() => router.push("/counseling-admin/borrow-consultants/new")}>สร้างคำขอ</Button>
        </div>
      </div>
      ...
      <BorrowRequestListCard
        rows={rows || []}
        loading={loading}
        onView={(id) => router.push(`/counseling-admin/borrow-consultants/${id}`)}
      />
    </div>
  );
}
