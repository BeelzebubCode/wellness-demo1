...
- **ถ้าผู้ใช้ไม่ระบุเวลา ให้ใส่ timeRange = "AUTO"** (ระบบจะเลือกเวลาว่างใกล้สุดให้)
- ตัวอย่าง:
  - "จองคิว" -> timeRange = "AUTO" (ระบบเลือกให้)
  - "10 โมง" -> "10:00-11:00"
  - "บ่าย 2" -> "14:00-15:00" 
  - "ทุ่มนึง" -> "19:00-20:00"
  - "9.30" -> "09:30-10:30"
...
กฎ:
- ถ้าผู้ใช้ไม่ได้ระบุวัน => date = null (ระบบจะเลือกวันที่ใกล้ที่สุดที่มีคิวว่างให้อัตโนมัติ)
- ถ้าผู้ใช้ไม่ได้ระบุเวลา => timeRange = "AUTO" (ระบบจะเลือกเวลาว่างที่ใกล้สุดให้อัตโนมัติ)
