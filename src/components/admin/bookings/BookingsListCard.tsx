  ...
  const styles =
    tone === "amber"
      ? {
          ...
          icon:
            "bg-amber-100 text-amber-800 group-hover:bg-amber-200/70",
      ...
      : {
          ...
          icon:
            "bg-emerald-100 text-emerald-800 group-hover:bg-emerald-200/70",
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="hidden md:grid grid-cols-[1.35fr,0.9fr,1.15fr,0.9fr,1.2fr] text-xs font-bold text-gray-600">
              <div className="px-4 py-2 rounded-l-xl bg-gray-50 border border-gray-100">
                ผู้จอง
              </div>
              ...
              <div className="px-4 py-2 rounded-r-xl bg-gray-50 border border-gray-100 text-right">
                การจัดการ
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="px-4 py-3.5">
                      ...
                      >
                        ...
                        <span className="mt-1 inline-flex items-center text-[11px] font-semibold text-primary-600 opacity-0 group-hover:opacity-100 transition-opacity">
                          กดเพื่อดูรายละเอียด
