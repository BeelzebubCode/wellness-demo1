...
import type { CategoryItem, PaginatedResponse } from '@/features/data-center/types';
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl border p-4">
        <div className="flex items-center gap-2 bg-gray-100 px-3 py-2 rounded-lg max-w-md">
          ...
          <input
            placeholder="ค้นหา รหัส / ชื่อประเภท"
                    ...
                    data?.data.map((item) => {
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-gray-50/50 text-sm">
                          ...
                          {/* Pending */}
                          <td className="px-6 py-4 text-center">
                            <span className={`font-medium ${item.pendingCount > 0 ? 'text-amber-600' : 'text-gray-400'}`}>
                              {item.pendingCount}
                            </span>
                          </td>
