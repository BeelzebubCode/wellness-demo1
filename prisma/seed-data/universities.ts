export const universitiesData = [
  ...
  { code: "MFU", th: "มหาวิทยาลัยแม่ฟ้าหลวง", en: "Mae Fah Luang University", province_code: "CRI", is_active: true }, // ต้องมี CRI
  { code: "MJU", th: "มหาวิทยาลัยแม่โจ้", en: "Maejo University", province_code: "CNX", is_active: true },
  { code: "UP", th: "มหาวิทยาลัยพะเยา", en: "University of Phayao", province_code: "PYO", is_active: true }, // ต้องมี PYO
  ...
  { code: "MSU", th: "มหาวิทยาลัยมหาสารคาม", en: "Mahasarakham University", province_code: "MKM", is_active: true }, // ต้องมี MKM
  { code: "SURO", th: "มหาวิทยาลัยเทคโนโลยีสุรนารี", en: "Suranaree University of Technology", province_code: "NRM", is_active: true },
  { code: "UBU", th: "มหาวิทยาลัยอุบลราชธานี", en: "Ubon Ratchathani University", province_code: "UBN", is_active: true },
  { code: "NPU", th: "มหาวิทยาลัยนครพนม", en: "Nakhon Phanom University", province_code: "NPM", is_active: true }, // ต้องมี NPM
  { code: "KSU", th: "มหาวิทยาลัยกาฬสินธุ์", en: "Kalasin University", province_code: "KSN", is_active: true }, // ต้องมี KSN
  ...
  { code: "WU", th: "มหาวิทยาลัยวลัยลักษณ์", en: "Walailak University", province_code: "NST", is_active: true }, // ต้องมี NST
  { code: "TSU", th: "มหาวิทยาลัยทักษิณ", en: "Thaksin University", province_code: "SKA", is_active: true },

  // ===== RAJABHAT (ตัวหลักที่ใช้จริง) =====
  ...
  { code: "RSU", th: "มหาวิทยาลัยรังสิต", en: "Rangsit University", province_code: "NBI", is_active: true }, // ต้องมี NBI
